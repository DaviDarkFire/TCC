...
class GUI():
    def __init__(self):
        ...
        self.frame_checkbox.place(relx=0.00, rely=0.73,relwidth=1, relheight=0.1)
        ...
        ##################################################Criação de widgets
        self.bt_open = tk.Button(self.frame_dir, text ="1º Abrir Banco de Faces", command = self.abrir_banco_faces)
        self.bt_open.place(relx=0.25, rely=0.27, relwidth=0.5, relheight=0.1)
        self.bt_train = tk.Button(self.frame_dir, text ="2º Atualizar Banco", command = self.update_facebank)
        self.bt_train.place(relx=0.25, rely=0.38, relwidth=0.5, relheight=0.1)
        self.bt_open = tk.Button(self.frame_dir, text ="3º Abrir Faces Desconhecidas", command = self.abrir)
        self.bt_open.place(relx=0.25, rely=0.49, relwidth=0.5, relheight=0.1)
        self.bt_ident = tk.Button(self.frame_dir, text ="4º Identificar", command = self.identify)
        self.bt_ident.place(relx=0.25, rely=0.60, relwidth=0.5, relheight=0.1)
